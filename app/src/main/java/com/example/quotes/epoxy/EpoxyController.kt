 ...
 */
fun MyBaseMvRxFragment.simpleController(
 ...
 */
fun <S : MavericksState, A : MavericksViewModel<S>> MyBaseMvRxFragment.simpleController(
    viewModel: A,
 ...
 */
fun <A : MavericksViewModel<B>, B : MavericksState, C : MavericksViewModel<D>, D : MavericksState> MyBaseMvRxFragment.simpleController(
    viewModel1: A,
    viewModel2: C,
...
fun <A : MavericksViewModel<B>,
        ...
        F : MavericksState>
        MyBaseMvRxFragment.simpleController(
    viewModel1: A,
    viewModel2: C,
    viewModel3: E,
